...
import { RiBuildingLine, RiGlobalLine, RiLockLine, RiMoreFill, RiShieldUserLine, RiVerifiedBadgeLine } from '@remixicon/react'
...
import { getAppPermissionSummary } from './permission-summary'
...
const AppCard = ({ app, onRefresh }: AppCardProps) => {
  ...
  const permissionSummary = useMemo(() => getAppPermissionSummary(app, t), [app, t])
      ...
      >
        <div className="flex h-[66px] shrink-0 grow-0 items-center gap-3 px-[14px] pb-3 pt-[14px]">
          ...
          <div className="flex h-5 shrink-0 items-center gap-1">
            <Tooltip asChild={false} popupContent={permissionSummary}>
              <RiShieldUserLine className="h-4 w-4 text-text-quaternary" />
            </Tooltip>
