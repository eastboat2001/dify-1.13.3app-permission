...
const WebSSOForm: FC = () => {
  ...
  const useConsoleSignin = shouldUseConsoleSigninForLocalAppPermission(
  ...
  useEffect(() => {
    if (!redirectUrl || !useConsoleSignin)
      return

    setPostLoginRedirect(getDecodedRedirectUrl(redirectUrl))
    router.replace('/signin')
  }, [redirectUrl, router, useConsoleSignin])
