...
import { getShareCodeFromPathname, getShareCodeFromRedirectUrl } from './web-app-context-utils'
...
const WebAppStoreProvider: FC<PropsWithChildren> = ({ children }) => {
  ...
  const shareCode = getShareCodeFromRedirectUrl(redirectUrlParam, window.location.origin) || getShareCodeFromPathname(pathname)
  useEffect(() => {
