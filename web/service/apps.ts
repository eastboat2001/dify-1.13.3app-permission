...
import type { AppIconType, AppModeEnum, AppPermissionSettings, AppPermissionUpdatePayload, ModelConfig } from '@/types/app'
...
export const fetchAppPermissions = (appID: string): Promise<AppPermissionSettings> => {
  return get<AppPermissionSettings>(`apps/${appID}/permissions`)
}

export const updateAppPermissions = (
  appID: string,
  body: AppPermissionUpdatePayload,
): Promise<AppPermissionSettings> => {
  return put<AppPermissionSettings>(`apps/${appID}/permissions`, { body })
}
