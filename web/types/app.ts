...
export type AppEditPermissionScope = 'only_creator' | 'selected_editors' | 'all_editors'
export type AppUsePermissionScope = 'only_creator' | 'selected_members' | 'all_members' | 'public'

export type AppPermissionSettings = {
...
export type AppPermissionUpdatePayload = Pick<AppPermissionSettings, 'edit_scope' | 'edit_members' | 'use_scope' | 'use_members'>
...
export type App = {
  ...
  edit_scope?: AppEditPermissionScope
  edit_member_count?: number
  use_scope?: AppUsePermissionScope
  use_member_count?: number
}
